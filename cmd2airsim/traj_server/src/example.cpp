...
//     double x1 = 5.0;  // 第一个固定点的x坐标
//     double y1 = 5.0;  // 第一个固定点的y坐标
//     double altitude1 = 5.0; // 第一个固定点的高度
//     double yaw1 = 0.0; // 第一个固定点的yaw角

//     double x2 = 2.0;  // 第二个固定点的x坐标
//     double y2 = 2.0;  // 第二个固定点的y坐标
//     double altitude2 = 8.0; // 第二个固定点的高度
//     double yaw2 = M_1_PI/3; // 第二个固定点的yaw角
...
//             point.position.x = x1;
//             point.position.y = y1;
//             point.position.z = altitude1;
//             point.yaw = yaw1;
//         } else if (elapsed_time.toSec() < 10.0) {
//             // 发送第二个固定点
//             point.position.x = x1;
//             point.position.y = y1;
//             point.position.z = altitude1;
